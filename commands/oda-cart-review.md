...
Review my Oda cart before checkout.

## Step 1: Fetch cart

Call the `cart_get_contents` tool to retrieve the current cart contents.
...
Do NOT remove anything yet. Present the pruning plan and wait for my approval before making
any changes to the cart.
